...
An **Active Directory (AD) attack** is an attempt to compromise an organization’s **Active Directory**, the system that manages users, groups, permissions, and security policies in a Windows network.
